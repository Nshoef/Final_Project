...
public class ManagerServiceServiceLocator extends org.apache.axis.client.Service implements service.ManagerServiceService {
    ...
    private java.lang.String ManagerService_address = "http://localhost:8080/Project-_Polling_Server/services/ManagerService";
    ...
    public service.ManagerService getManagerService() throws javax.xml.rpc.ServiceException {
    ...
    public service.ManagerService getManagerService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.ManagerServiceSoapBindingStub _stub = new service.ManagerServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.ManagerService.class.isAssignableFrom(serviceEndpointInterface)) {
                service.ManagerServiceSoapBindingStub _stub = new service.ManagerServiceSoapBindingStub(new java.net.URL(ManagerService_address), this);
                _stub.setPortName(getManagerServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service", "ManagerServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service", "ManagerService"));
        }
